# Contributing to quotestreak

## Setup

```
git clone https://github.com/nulljosh/quotestreak.git
cd quotestreak
open Package.swift   # or the .xcodeproj/.xcworkspace, if present
```

## Run

Build and run from Xcode, or `swift run` for CLI targets.
